      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-6 md:px-8">
        <Link to="/" className="flex items-center gap-3">
          {config?.logo_url ? (
            ...
            <span className="font-serif text-2xl italic tracking-tight text-editorial-ink">
        ...
        <div className="flex items-center gap-4">
          <Link 
            to="/admin" 
            className="rounded-sm border border-editorial-ink px-5 py-2 text-[10px] font-bold uppercase tracking-[1px] text-editorial-ink transition-all hover:bg-editorial-ink hover:text-white"
          >
            Painel Admin
          </Link>
        </div>
